...
@PartitionMapper(name = "JqlInput")
@Documentation("TODO fill the documentation for this mapper")
public class JqlInputMapper implements Serializable {
    private final JqlInputMapperConfiguration configuration;
    private final JqlService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public JqlInputMapper(@Option("configuration") final JqlInputMapperConfiguration configuration,
    ...
    @Split
    public List<JqlInputMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 JqlInputMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public JqlInputSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new JqlInputSource(configuration, service, recordBuilderFactory);
    }
}